...
@app.route('/machine3/piece', methods=['GET'])
@app.route('/machine3/pieces', methods=['GET'])
def view_pieces():
    session = Session()
...
@app.route('/machine3/piece/<int:piece_ref>', methods=['GET'])
...
# Machine Routes #######################################################################################################
@app.route('/machine3/status', methods=['GET'])
...
# Health Check #######################################################################################################
@app.route('/machine3/health', methods=['HEAD', 'GET'])
