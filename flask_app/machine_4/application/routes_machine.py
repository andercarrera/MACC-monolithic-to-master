...
@app.route('/machine4/piece', methods=['GET'])
@app.route('/machine4/pieces', methods=['GET'])
def view_pieces():
    session = Session()
...
@app.route('/machine4/piece/<int:piece_ref>', methods=['GET'])
...
# Machine Routes #######################################################################################################
@app.route('/machine4/status', methods=['GET'])
...
# Health Check #######################################################################################################
@app.route('/machine4/health', methods=['HEAD', 'GET'])
